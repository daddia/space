...
`@daddia/space` is the operational CLI for a daddia delivery space. It provides commands to sync external data sources into `.space/sources/` and (later) publish authored docs back to external systems.
