...
/** Shape of the profile YAML files in @tpw/skills/profiles/. */
...
export class SkillsProfileNotFoundError extends Error {
  constructor(profileName: string) {
    super(`Profile '${profileName}' not found in @tpw/skills/profiles/`);
...
/**
 * Read the named profile from node_modules/@tpw/skills/profiles/ and return
 ...
 *   directory under node_modules/@tpw/skills/.
 */
export function loadSkillsProfile(workspaceRoot: string, profileName: string): string[] {
  ...
  const skillsSourceDir = path.join(workspaceRoot, 'node_modules', '@tpw', 'skills');
