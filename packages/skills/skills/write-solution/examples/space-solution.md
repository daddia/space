...
separately in `docs/design/space-artefact-model.md` Section 6.
...
`docs/design/space-artefact-model.md` Section 3.3.
...
- Description eval loop (CI): 20 representative queries x 3 samples per
  ...
  (`docs/design/space-artefact-model.md` Section 3.4).
...
per Ambler JBGE (`docs/design/space-artefact-model.md` Section 2.3).
