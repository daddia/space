...
| review-codebase | Performs a comprehensive, first-principles audit of a codebase as a Senior Software Architect. Use when the user... | codebase review | engineering | architect | solution.md, AGENTS.md | review |
