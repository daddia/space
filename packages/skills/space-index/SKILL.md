...
| refine-docs | Documents the sprint-end refinement session: promotes WP-local ADR candidates into solution.md, archives superseded... | refine-session.md | delivery | architect, engineer | solution.md, design.md | refine-session.md |
...
| review-product | Review and improve a product strategy document (product.md) at any scope — portfolio, product, or domain. Acts as a... | product.md review | discovery | pm, founder | product.md | product.md (amended), review summary |
...
| write-product | Drafts product.md at portfolio, product, or domain scope. Portfolio scope: one document binding multiple products... | product.md | discovery | pm, founder | — | product.md |
| write-roadmap | Drafts roadmap.md at portfolio, product, or domain scope. Portfolio scope: a combined sequencing document binding... | roadmap.md | discovery | pm | product.md | roadmap.md |
