...
- Switch registry to GitLab Package Registry (`@daddia:registry`); `license` changed to `UNLICENSED`
- Fix `repository.url` normalisation warning

## 0.1.2

- New skill: Validate
- Generalise example task IDs in all skills from project-specific `SPACE-##` to generic `PROJ-##`
