...
| validate | Performs a final stakeholder validation that an epic is complete against its backlog.md acceptance criteria. Use when... | validation report | delivery | backlog.md, solution.md | validation |
...
| write-product | Drafts product.md for a platform or domain sub-product in pitch mode (Phase 0, Shape Up, ≤2 pages) or product mode... | product.md | discovery | — | product.md |
| write-roadmap | Drafts roadmap.md for a platform or domain in Now / Next / Later format with outcome-based phases and exit criteria.... | roadmap.md | discovery | product.md | roadmap.md |