...
| refactor-code | Refactors existing code to address issues raised in a code review or to improve quality without changing behaviour. Use... | code | delivery | review output, code | code |
