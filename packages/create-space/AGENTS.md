...
`@daddia/create-space` is a scaffolding CLI that initialises a new daddia delivery workspace. It runs interactively or non-interactively and outputs a ready-to-use workspace directory with the standard file structure.
...
- Keep the template directory in sync with the daddia workspace template conventions.
