...
sources:
  ...
  issues:
    ...
    project: STORE
    url: https://your-org.atlassian.net/browse/STORE

  docs:
    provider: confluence
    space: STOREFRONT
    url: https://your-org.atlassian.net/wiki/spaces/STOREFRONT/overview
  ...
  hosting:
    provider: vercel
    url: https://vercel.com/daddia/storefront-next
...
Run syncs from the workspace root using the `space` CLI (provided by `@daddia/space`):
