...
- **Confluence:** [Cart on Confluence](https://templeandwebster.atlassian.net/wiki/spaces/storefront/folder/4456808650)
- **GitLab:** [Cart on GitLab](https://gitlab.com/templeandwebster/storefront/storefront-space/-/tree/main/domain/cart?ref_type=heads)
...
- **Cart as a worked example** — every artefact at every level, in a real domain mid-flight: [Cart on GitLab](https://gitlab.com/templeandwebster/storefront/storefront-space/-/tree/main/domain/cart?ref_type=heads).
